    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') //location.reload();  force reload from server and not cache || depraved
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            _context2.next = 10;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3BhcmVhdnRhbGUiLCJhIjoiY2tzZWdwcHp5MTA4bDJ2bzM5c2Z1dHNocCJ9.zzDwCQUXRbmPNifkujpFsw';
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); // arr
